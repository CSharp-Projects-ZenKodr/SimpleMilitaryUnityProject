...
namespace Pathfinding {
	...
	public partial class AIPath : AIBase, IAstarAI {
		...
		/// <summary>
		/// onTargetReached is invoked in a similar manner to virtual OnTargetReached()
		/// </summary>
		public delegate void OnTargetReachedDelegate();
		...
		protected override void MovementUpdateInternal (float deltaTime, out Vector3 nextPosition, out Quaternion nextRotation) {
			...
			if (!prevTargetReached && reachedEndOfPath) onTargetReached?.Invoke();
			float slowdown;
