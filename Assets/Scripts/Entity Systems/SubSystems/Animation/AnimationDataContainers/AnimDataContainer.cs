...
namespace Entity_Systems.SubSystems.Animation.AnimationDataContainers {
    [CreateAssetMenu(order = 1, fileName = "AnimDataContainer", menuName = "Animations/Containers/AnimDataContainerNew")]
    [Serializable]
    public class AnimDataContainer : DataContainer<ClipState.Transition> {
        //[SerializeField] protected override List<ClipState.Transition> DataList { get; }
        ...
        //     Debug.Log("Animator Data AnimDataContainer has been enabled");
