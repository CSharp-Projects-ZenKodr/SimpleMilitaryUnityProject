...
namespace DestroyIt
{
    ...
    public class InputManager : MonoBehaviour
    {
        ...
        {
            UnityEngine.Animation anim = axeTransform.GetComponentInChildren<UnityEngine.Animation>();
        ...
        {
            UnityEngine.Animation anim = repairWrenchTransform.GetComponentInChildren<UnityEngine.Animation>();
