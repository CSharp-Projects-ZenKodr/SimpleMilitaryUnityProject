...
namespace DestroyIt.Scripts.Managers
{
    /// <summary>
    ...
    public class DestructionManager : MonoBehaviour
    {
        ...
        private static void UnparentSpecifiedChildren(Destructible obj)
        {
            ...
            foreach (GameObject child in obj.unparentOnDestroy)
            {
                ...
                UnityEngine.Animation[] animations = child.GetComponentsInChildren<UnityEngine.Animation>();
                foreach (UnityEngine.Animation anim in animations)
                    anim.enabled = false;
            }
        }
